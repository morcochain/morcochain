...
public:
    ...
    boost::signals2::signal<bool (int64 nFeeRequired, unsigned char cUnit), boost::signals2::last_value<bool> > ThreadSafeAskFee;
    ...
    /** Liquidity changed. */
    boost::signals2::signal<void ()> NotifyLiquidityChanged;
