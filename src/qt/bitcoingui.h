...
public:
    ...
    */
    ...
    // nubit:
    QAction * getVoteAction() { return voteAction; }
    QAction * getParkAction() { return parkAction; }
    QAction * getSwitchUnitAction() { return switchUnitAction; }
    QVector<QAction *> * getChangeUnitActions() { return &changeUnitActions; }
