    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Nu") + " - " + tr("Wallet"));
    setStyle(QStyleFactory::create("cleanlooks"));
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/nu"));
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/nu"), tr("&About Nu"), this);
    aboutAction->setStatusTip(tr("Show information about Nu"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Nu"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/nu"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/nu_testnet"));
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction requires a network fee of %1. "
          "Do you want to pay the fee and continue?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, nFeeRequired));
...
{
    bool fShares = (walletFrame->getUnit() == 'S');
    switch(status)
    {
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(walletFrame->isUnlockedForMintingOnly()? tr("Wallet is <b>encrypted</b> and currently <b>unlocked for block minting only</b>") : tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
        encryptWalletAction->setEnabled(false); // TODO: decrypt currently not supported
        unlockForMintingAction->setEnabled(fShares && walletFrame->isUnlockedForMintingOnly());
        unlockForMintingAction->setChecked(fShares && walletFrame->isUnlockedForMintingOnly());
        break;
...
{
    if (walletFrame) walletFrame->gotoVotePage();
}
