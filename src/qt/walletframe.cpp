...
void WalletFrame::changeUnit(const QString &unit)
{
    walletStack->changeUnit(unit);
}

void WalletFrame::exportPeercoinKeys()
{
    walletStack->exportPeercoinKeys();
}

unsigned char WalletFrame::getUnit() const
{
    return walletStack->getUnit();
}

bool WalletFrame::isUnlockedForMintingOnly() const
{
    return walletStack->isUnlockedForMintingOnly();
}

void WalletFrame::gotoVotePage()
{
    walletStack->gotoVotePage();
}

void WalletFrame::gotoParkPage()
{
